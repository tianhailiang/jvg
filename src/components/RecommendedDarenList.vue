<template>
  <el-dialog title="留学达人推荐列表" :visible.sync="dialogFormVisible" :before-close="handleClose" 
  width="80%">
    <el-form :inline="true">
      <div >
      ...
      <el-form-item label="性别：">
        <el-select v-model="sex" size="small" style="width:120px">
          <el-option
      ...
      <el-form-item label="认证：">
        <el-select v-model="approveStatus" size="small" style="width:130px">
          <el-option
      ...
      <el-form-item label="用户角色：">
        <el-select v-model="type" size="small" style="width:140px">
          <el-option
...
export default {
  ...
  methods: {
    ...
    onSubmit (origin) {
      ...
      axios.post('/api/c/operation-management/arrposid/abroad/list.json', {
