<template>
    <el-row class="nav_top">
        <el-col :xs="8" :sm="6" :md="4" :lg="4" :xl="1"><div class="grid-content bg-purple-light">
          <img src="@/assets/logo_common_black.png" alt="" width="145" height="50"></div>
        </el-col>
...
<style scoped>
.title{color: #2c3e50;line-height: 60px;}
.nav_top{ 
  overflow: hidden; 
  padding-left:20px;
  margin-bottom: 25px;
