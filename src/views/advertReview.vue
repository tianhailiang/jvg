<template>
  <section class="advert-review-content" style="overflow:hidden;max-width:1200px;">
    ...
    <el-table :data="tableData3" border>
      ...
      <el-table-column prop="name" label="广告位类型" width="110"></el-table-column>
      <el-table-column prop="name" label="所有权" width="60"></el-table-column>
      <el-table-column prop="name" label="开始时间" width="110"></el-table-column>
      <el-table-column prop="name" label="结束时间" width="110"></el-table-column>
      <el-table-column prop="name" label="渠道" width="80"></el-table-column>
      <el-table-column prop="name" label="业务频道" width="110"></el-table-column>
      <el-table-column prop="name" label="审核状态" width="100"></el-table-column>
      <el-table-column prop="name" label="销售方" width="110"></el-table-column>
